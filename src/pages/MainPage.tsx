          ...
          >
            ...
            <Grid size={{ xs: isDesktop ? 9 : undefined }}>
              <Typography sx={{ fontSize: '16px', fontFamily: 'Roboto' }}>
                ...
                chatbox. But I had only decided to pursue software engineering as a
                career in 2021 by signing up for a bootcamp by{' '}
                <Link
                  className='text-link'
                ...
                , and I am currently working on some really exciting digital products
                at{' '}
                <Link
                  className='text-link'
