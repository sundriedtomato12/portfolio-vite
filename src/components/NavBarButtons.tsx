      ...
      {isDesktop ? (
          ...
          {navBarItems.map((item) => (
            <Button
              ...
              sx={{
                ...navButtonStyle,
                borderBottom:
                  currentPage === item ? activeNavBorderBottom : "none",
                color:
                  currentPage === item
                    ? colorPalette.green.light
                    : colorPalette.slate.lightest,
              }}
            >
        ...
        <>
          ...
          <Drawer
            ...
            PaperProps={{
              sx: { backgroundColor: colorPalette.navy.dark, width: "40%" },
            }}
          >
            <List>
              <ListItemButton sx={{ display: "flex", justifyContent: "right" }}>
                <CloseIcon
                  sx={{ fontSize: "22px", color: colorPalette.white }}
                  onClick={() => {
                    setIsOpen(false);
                  }}
                />
